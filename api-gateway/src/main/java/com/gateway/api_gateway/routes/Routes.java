...
public class Routes {
    ...
    public RouterFunction<ServerResponse> productServiceSwagger(){
        return GatewayRouterFunctions.route("product_service_swagger").route(RequestPredicates
    ...
    public RouterFunction<ServerResponse> orderServiceSwagger(){
        return GatewayRouterFunctions.route("order_service_swagger").route(RequestPredicates
    ...
    public RouterFunction<ServerResponse> inventoryServiceSwagger(){
        return GatewayRouterFunctions.route("inventory_service_swagger").route(RequestPredicates
